...
class EventMap
{
    ...
    public static function BitBucket()
    {
        return [
            ...
            // 'repo:commit_status_updated' => 'Hook\BitBucket\Repository\CommitStatusUpdated',
            // 'issue:created' => 'Hook\BitBucket\Issue\Created',
            // 'issue:updated' => 'Hook\BitBucket\Issue\Created',
            // 'issue:comment_created' => 'Hook\BitBucket\Issue\CommentCreated',
            // 'pullrequest:created' => 'Hook\BitBucket\PullRequest\Created',
            // 'pullrequest:updated' => 'Hook\BitBucket\PullRequest\Updated',
            // 'pullrequest:approved' => 'Hook\BitBucket\PullRequest\Approved',
            // 'pullrequest:unapproved' => 'Hook\BitBucket\PullRequest\Unapproved',
            // 'pullrequest:fulfilled' => 'Hook\BitBucket\PullRequest\Fulfilled',
            // 'pullrequest:rejected' => 'Hook\BitBucket\PullRequest\Rejected',
            // 'pullrequest:comment_created' => 'Hook\BitBucket\PullRequest\CommentCreated',
            // 'pullrequest:comment_updated' => 'Hook\BitBucket\PullRequest\CommentUpdated',
            // 'pullrequest:comment_deleted' => 'Hook\BitBucket\PullRequest\CommentDeleted',
        ];
    }
}
